...
void init()
{
	puts(
		...
		"--timeout_response :	timeout of response\n"
                "--custom_request:       request to fuzz\n"  
		YELLOW
...
static struct option long_options[] =
{
	...
	{"custom_request", required_argument, NULL, 'r'},
	{NULL, 0, NULL, 0}
};
...
main(int argc, char ** argv)
{
	...
	while((c = getopt_long(argc, argv, "h:p:f:z:c:P:o:u:s:T:V:r:",long_options,NULL)) != -1)
		switch(c) 
		{
			case 'h':
				pack[0] = optarg;
